...
flattenMeasureReport = function(measureReport){
  ...
  result.reasonCode = get(measureReport, 'reason[0].coding[0].code', '');
...
//     if(process.env.NODE_ENV === "test") console.log("MeasureReportsTable[data]", data);
//     return data;
//   }
...
function MeasureReportsTable(props){
  console.log('MeasureReportsTable.props', props);
  // console.log('MeasureReportsTable.props.measureReports', props.measureReports);
  ...
  function removeRecord(_id){
    console.log('Remove measureReport ', _id)
  ...
  if(measureReportsToRender.length === 0){
    console.log('No measureReports to render');
      ...
      if(props.multiline){
        tableRows.push(
          <TableRow className="measureReportRow" key={i} onClick={ rowClick(measureReportsToRender[i]._id)} >
            ...
            { renderReasonCode(measureReportsToRender[i].reasonCode)}
            { renderReason(measureReportsToRender[i].reasonDisplay)}
            {/* <TableCell className='reasonCode' >{measureReportsToRender[i].reasonCode }</TableCell>
